...
GFFe=p*Ye-HUC*Yp-idL*Ldf-ifxf*Lfxf*ene#(*Nominal, domestic currency*)(*22*) #Check interests on deposits
...
gproff=Yd-w*L-pw*en*IM-idL*Ldf-ifxf*Lfxf*en-tau_r*X_a#(*Nominal, domestic currency*)(*34*) #Check deposit interests
#Actual Net Profits
...
LfxfDotdes=betalf*TFNf/en#(*27*)#Check equation 
#Unemployment rate 
...
RfxmbDot=RfxDot-RfxcbintDot#(*Nominal, foreign currency*)(*50*)#Total Financial Needs of Banks
TFNb=(LdfDot+BgbDot)+rrr*(Dep+DepDot+Depg+DepgDot)-(DepDot+DepgDot+OFbDot)-Res #(*Nominal, domestic currency*)(*51*)
...
#Actual gross profits
gprofb=idL*Ldf+ibg*Bgb-idep*(Dep+Depg)-ip*Ad+ifxf*Lfxf*en -ifxb*Lfxb*en#(*Nominal, domestic currency*)(*56)
...
AFC=(Ad*ip+idep*(Dep+Depg))/(Ad+Dep+Depg)#(*Nominal, domestic currency*)(*59*)
#Actual net profits
...
ConT =mpc1*(YD_Lh)+mpc3*(YF_Lh)+mpc2*(Dep+Bgh) #(*Nominal, domestic currency*)(*80*) #Check Equation: Expected Firms profits
#Households net labour income
YD_Lh=((1-tauw)*w*L+Gs) #(*nominal,domestic currency*)
#Households financial income
YF_Lh=idep*Dep+Rem*en+ibg*Bgh+Divb+Divfe
#Households savings  
Sh =(YD_Lh+YF_Lh)-(Con)#(*Nominal, domestic currency*)(*85*) 
...
Gs = fi3*w*(fi4*(Pop-L))#(*Nominal, domestic currency*)(*64*)
#Total revenue
...
betagff=beta12+ beta1*(arbrow) #(*91*)
...
IdoverYpd = Id/Ypd
#Inflation
Infl = pDot/p#Government External Debt (%GDP)
...
Bgb=BgDot-BghDot-BgrowDot#Government Bonds Purchased by the banks (*Nominal, domestic currency*)(*70*)
...
GDPw=(alphagw)*GDPw #World GDP growth (*Not numbered)
...
Lfxf=ji_Lfx*LfxfDotdes#New FX Loans borrowed by the firms(*Nominal, foreign currency*)(*28*)
