...
TFNb=(LdfDot+BgbDot+LdhDot)+rrr*(Dep+DepDot)-(DepDot+OFbDot)-Res #(*Nominal, domestic currency*)(*51*)
...
#Actual gross profits
gprofb=idLh*Ldh+idL*Ldf+ibg*Bgb-idep*Dep-ip*Ad+ifxf*Lfxf*en -ifxb*Lfxb*en#(*Nominal, domestic currency*)(*56)
...
#Target Consumption 
ConTd =mpc1*((1-tauw)*w*L+Ge)+mpc3*(idep*Dep+Rem*en+ibg*Bgh+(FFe-sf*FFe-DfxfDot*ene)+Divb)+mpc2*(Dep+Bgh) #(*Nominal, domestic currency*)(*80*) #Check Equation: Expected Firms profits
#Consumo
Con=Cond+LdhDot #
ipsilon1=1-2*idLh #Bur =((0.02+idLh)*Ldh/(1-tauw)*w*    
#Households savings  
Sh =(1-tauw)*w*L+Ge+idep*Dep+Rem*en+ibg*Bgh+ Divf+Divb-Con-idLh*Ldh#(*Nominal, domestic currency*)(*85*) 
